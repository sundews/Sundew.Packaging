...
namespace Sundew.Build.Publish.Logging
{
    ...
    internal class NuGetToMsBuildLoggerAdapter : global::NuGet.Common.ILogger
    {
        ...
        {
            this.log.LogMessage(MessageImportance.Low, $"NuGet Debug: {data}");
        }

        public void LogVerbose(string data)
        {
            this.log.LogMessage(MessageImportance.Low, $"NuGet Verbose: {data}");
        }

        public void LogInformation(string data)
        {
            this.log.LogMessage(MessageImportance.Normal, $"NuGet Information: {data}");
        }

        public void LogMinimal(string data)
        {
            this.log.LogMessage(MessageImportance.Low, $"NuGet Minimal: {data}");
        }
        ...
        {
            this.log.LogMessage(MessageImportance.Normal, $"NuGet Summary: {data}");
        }
