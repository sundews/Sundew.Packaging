// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CopyPdbToSymbolCacheCommandTests.cs" company="Sundews">
...
public class CopyPdbToSymbolCacheCommandTests
{
    ...
    public CopyPdbToSymbolCacheCommandTests()
    {
        ...
        this.fileSystem.Setup(x => x.ReadAllBytes(It.IsAny<string>())).Returns(GetBytes(Assembly.GetExecutingAssembly().GetManifestResourceStream("Sundew.Packaging.Publish.Development.Tests.Internal.Commands.Sundew.Packaging.Publish.pdb")!));
    }
