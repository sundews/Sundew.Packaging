// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LatestPackageVersionCommandTests.cs" company="Sundews">
...
public class LatestPackageVersionCommandTests
{
    ...
    {
        this.testee = new LatestPackageVersionCommand(New.Mock<ILogger>(), New.Mock<NuGet.Common.ILogger>());
    }
