...
namespace Sundew.Packaging.Publish
{
    ...
    public class PublishInfo
    {
        ...
        public PublishInfo(string stage, string feedSource, string pushSource, string? apiKey, string? symbolsPushSource, string? symbolsApiKey, bool isEnabled, string version)
        {
            this.Stage = stage;
