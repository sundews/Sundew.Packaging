// --------------------------------------------------------------------------------------------------------------------
// <copyright file="describe_package_updater_facade.cs" company="Sundews">
...
public class describe_package_updater_facade : Nspec
{
    void when_updating_packages()
    {
        this.beforeEach = () =>
        {
            ...
            {
                this.nuGetPackageVersionFetcher.Setup<INuGetPackageVersionFetcher, Task<IEnumerable<NuGetVersion>>>(n => n.GetAllVersionsAsync(
                        It.IsAny<string>(),
                        It.IsAny<string>(),
                        x.Id))
